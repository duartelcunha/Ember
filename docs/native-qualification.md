...
recorded in `DECISIONS.md` and `docs/threat-model.md`. At local qualification time,
the main checkout and installed Ember were unchanged.
...
Gitleaks found no secrets in the candidate changes. The browser preview tests use
