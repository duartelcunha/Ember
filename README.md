...
[Windows evaluation candidate 1.1.0-rc.1](https://github.com/duartelcunha/Ember/releases/tag/v1.1.0-rc.1) is available with a verified updater signature. Existing installations should use `/UPDATE` and preserve a configuration backup; do not run the old uninstaller first. See the [native test and installation evidence](docs/native-qualification.md).
